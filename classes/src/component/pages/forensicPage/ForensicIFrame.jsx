...
const [lockedVideos, setLockedVideos] = useState({});
  ...
  const LockedPlaceholder = ({ title }) => (
    <div className="flex flex-col items-center justify-center h-80 bg-gradient-to-br from-blue-600 to-purple-700 text-white text-center p-5">
      ...
      <p className="opacity-90 text-sm">This video is currently locked. Click unlock to view.</p>
    </div>
  );
  ...
  return (
    <div className="p-5 max-w-7xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {videos.map(video => (
          <div key={video.id} className="border border-gray-200 rounded-lg overflow-hidden shadow-lg hover:shadow-xl transition-shadow">
  ...
  <h1 className='text-center text-3xl font-bold p-4 text-white bg-gradient-to-r from-purple-600 to-pink-600 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 border-2 border-white/20 cursor-pointer ' onClick={handalDoubt}>
    Doubt Class 
  </h1>
</div>
