      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          ...
          <div className="lg:col-span-1">
            <div className="mb-6">
              ...
              <p className="text-gray-300 text-sm leading-relaxed">
                Indresh Kumar, also known as Rahul Maurya, is the visionary Founder and CEO of Happy Digital Bharat, dedicated to empowering digital transformation across India.
              </p>
            </div>
          ...
          <div className="lg:col-span-1">
            ...
            <div className="mt-8">
              <h3 className="text-lg font-semibold mb-4 text-blue-400">Help & Support</h3>
              <ul className="space-y-3">
                {[
          ...
          <div className="lg:col-span-1">
            <h3 className="text-lg font-semibold mb-4 text-blue-400">Reach Us</h3>
            <ul className="space-y-4">
              <li className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm">
                  ...
                  <div>Madhupur, Robertsganj, Sonbhadra, Uttar Pradesh, India</div>
                </div>
              </li>
              ...
              <li className="flex items-start space-x-3">
                ...
                <div className="text-gray-300 text-sm space-y-1">
                  <a href="tel:+918957445211" className="block hover:text-white transition-colors">
                    +91 8957445211
                  </a>
                  <a href="tel:+918081739493" className="block hover:text-white transition-colors">
                    +91 8081739493
                  </a>
                </div>
              </li>
