      ...
      <div className="container mx-auto px-6 relative z-10">
            ...
            {services.map((service, index) => {
              ...
              return (
                ...
                >
                  ...
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-gradientt-to-r from-blue-500 to-purple-600 group-hover:w-4/5 transition-all duration-500 rounded-full"></div>
                </div>
              );
            })}
          </div>
        ...
        <div className="mb-20">
          <div className="text-center mb-16">
            ...
            <div className="w-24 h-1 bg-gradient-to-r from-green-500 to-cyan-500 mx-auto mb-8 rounded-full"></div>
            ...
            {whyChooseUs.map((item, index) => {
              ...
              return (
                ...
                >
                  {/* Icon */}
                  <div className="mb-4 transform group-hover:scale-110 group-hover:rotate-3 transition-transform duration-500">
                    <div className="w-16 h-16 bg-gradient-to-br from-green-500/20 to-cyan-500/20 rounded-2xl flex items-center justify-center border border-white/10 group-hover:border-white/20 transition-all duration-500">
                      <IconComponent 
                        size={32} 
                  ...
                  {/* Title */}
                  <h4 className="text-xl font-bold text-white mb-3 group-hover:text-transparent group-hover:bg-gradient-to-r group-hover:from-green-400 group-hover:to-cyan-400 group-hover:bg-clip-text transition-all duration-300">
                    {item.title}
                  </h4>
                  ...
                  {/* Hover Gradient Border Bottom */}
                  <div className="absolute bottom-0 left-1/2 transform -translate-x-1/2 w-0 h-1 bg-gradient-to-r from-green-500 to-cyan-500 group-hover:w-4/5 transition-all duration-500 rounded-full"></div>
                </div>
              );
            })}
          </div>
